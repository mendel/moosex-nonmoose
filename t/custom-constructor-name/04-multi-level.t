...
isnt(Foo::Moose->meta->get_method('new_instance'), undef,
     'Foo::Moose gets its own constructor');

my $foo_moose_sub = Foo::Moose::Sub->new_instance;
...
is(Foo::Moose::Sub->meta->get_method('new_instance'), undef,
   'Foo::Moose::Sub just uses the constructor for Foo::Moose');

Foo::Moose->meta->make_immutable;
Foo::Moose::Sub->meta->make_immutable;
$foo_moose_sub = Foo::Moose::Sub->new_instance;
...
isnt(Foo::Moose::Sub->meta->get_method('new_instance'), undef,
